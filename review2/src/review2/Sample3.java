...
public class Sample3 {
	...
	public static void main(String[] args) {
		...
		// 즉, people 이란 단어에 "사람", baseball 이라는 단어에 "야구"라는 뜻이 부합되듯이 Map은 Key와 Value를 한 쌍으로 갖는 자료형이다.
		...
		// Map 인터페이스를 구현한 Map자료형에는 HashMap, LinkedHashMap, TreeMap등이 있다. 인터페이스에 대해서는 객체지향 챕터에서 자세하게 다룰 것이다.
		...
		map.put("people2", "사람2");
		map.put("baseball2", "야구2");
		System.out.println(map.keySet());// [baseball2,people,people2] 출력
